...
('Tarifa Premium', 59.99, 'Acceso completo a entrenamientos y dietas personalizadas', 'MENSUAL', 4),
('Tarifa Nutrición', 39.99, 'Asesoramiento nutricional completo', 'MENSUAL', 4);

-- Insertar rutina del empleado 5
INSERT INTO Rutina (nombre, descripcion, idCliente, idEmpleado) VALUES
('Rutina Fuerza Avanzada', 'Entrenamiento de fuerza con énfasis en hipertrofia', 10, 4),
('Rutina Quema Grasa', 'Circuito de alta intensidad para pérdida de grasa', 8, 4);

-- Insertar dieta del empleado 5
INSERT INTO Dieta (nombre, descripcion, idEmpleado) VALUES
('Dieta Hipocalórica', 'Reducción calórica para definir masa muscular', 4),
('Dieta Alto Rendimiento', 'Dieta enfocada en deportistas de alto rendimiento', 4);

-- Asignar tarifas a clientes
INSERT INTO ClienteTarifa (idCliente, idTarifa, estado, fechaContratacion) VALUES
(10, 4, 'ACTIVA', '2025-04-01'),
(8, 5, 'ACTIVA', '2025-04-01');
...
('2025-04-10', 78.5, 18.2, 38.1, 100.0, 85.0, 95.0, 'Progreso positivo', 10, 4),
('2025-04-10', 66.3, 22.5, 31.2, 90.0, 75.0, 92.0, 'Mejorar alimentación', 8, 4);