...
('Rutina Fuerza Avanzada', 'Entrenamiento de fuerza con énfasis en hipertrofia', 5, 5),
('Rutina Quema Grasa', 'Circuito de alta intensidad para pérdida de grasa', 3, 5);
...
(5, 4, 'ACTIVA', '2025-04-01'),
(3, 5, 'ACTIVA', '2025-04-01');
...
('2025-04-10', 78.5, 18.2, 38.1, 100.0, 85.0, 95.0, 'Progreso positivo', 5, 5),
('2025-04-10', 66.3, 22.5, 31.2, 90.0, 75.0, 92.0, 'Mejorar alimentación', 3, 5);